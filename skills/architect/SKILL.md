...
Use the arena runner defaults: two `judgment-worker` and two `code-worker`, each given a different starting constraint so the candidates diverge structurally.
