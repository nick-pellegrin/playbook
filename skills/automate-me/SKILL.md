---
name: automate-me
description: "Use for \"automate me\", \"create/update/refresh my -mode skill\", or capturing the user's working style as a skill. Drafts or revises a personal -mode skill via skill-creator and unslop."
...
Locate this project's transcripts before fanning out. They live under `~/.claude/projects/<slug>/`, where `<slug>` is this project's absolute path with every separator and colon turned into `-`. Use only that path. Don't glob across `~/.claude/projects/*/`. That crosses workspace boundaries and reads private chats from unrelated projects.
...
The **playbook** skill shows the shape. Read it for granularity. Don't copy its content. The user's rules are not the same as playbook's.
