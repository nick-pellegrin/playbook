---
name: cli-for-agents
description: Design or review a CLI so coding agents can run it reliably. Non-interactive flags, layered --help, stdin and pipelines, fast actionable errors, idempotency, dry-run. Use when building a CLI or writing its --help.
---
