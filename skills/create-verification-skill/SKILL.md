...
description: "Generate a project-local verification skill that drives your app the way a user does. Use for /create-verification-skill, or when a project has no scripted way to prove UI, CLI, or service behavior."
