...
description: Guard the Context Window. Context fills up with large outputs, long files, repeated reads, fan-out planning. Read this leaf in full before citing the principle.
