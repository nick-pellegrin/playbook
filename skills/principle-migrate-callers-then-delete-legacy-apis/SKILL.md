...
description: Migrate Callers Then Delete Legacy APIs. Introducing a new internal API while old callers exist. Read this leaf in full before citing the principle.
