...
description: Separate Before Serializing Shared State. Concurrent actors might write the same file, branch, key, or object. Read this leaf in full before citing the principle.
