...
description: Sequence Work into Verifiable Units. Multi-step work (sweeps, migrations, runs of similar edits) and how you stack commits and PRs. Read this leaf in full before citing the principle.
