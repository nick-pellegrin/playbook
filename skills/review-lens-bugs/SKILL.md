---
name: review-lens-bugs
description: The bugs, breakage, and security rubric. Read by the reviewer-bugs agent, and usable directly for a deep diff audit of correctness, breaking changes, security issues, devex regressions, and feature-gate leaks.
disable-model-invocation: true
---

# Review lens: bugs, breakage, security
...
# Final Response
IF you have medium-to-high priority / risk findings, and there is a PR for this branch, then check the PR/MR discussion using gh/glab cli to see if there are comments from a review bot or a human present.
...
Flag issues found by a review bot or a human in the PR/MR discussion that you include in your report.
